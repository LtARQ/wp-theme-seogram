  ...
  <footer class="page-footer bg-image" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/world_pattern.svg);">
    <div class="container">
      <div class="row mb-5">
...
<script>
  $('.page-section .container .next').addClass("abcxyz");
</script>
</body>
</html>